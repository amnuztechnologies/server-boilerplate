...
Once installed, heat over to `.env.example` file and replace `MONGO_DB_URI` with your Mongodb URI. and change the file name to `.env`
...
That's it! You have now set up your new server.
